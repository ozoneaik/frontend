                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <textarea class="form-control p-2" rows="4"
                                                        readonly>@if($leaveforms->reason){{$leaveforms->reason}}@elseไม่ได้กรอกเหตุผลการลา@endif</textarea>
                                                </div>
                                            </div>
                                            {{-- เอกสารประกอบการลา --}}
                                            <div class="col-md-12">
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <div class="form-group reason_pm">
                                                ...
                                                <textarea class="form-control" id="reason_pm" name="reason_pm"
                                                    rows="3"></textarea>
                                            </div>
                                            <div class="form-group allowed">
                                                ...
                                                <br>
                                                <input type="radio" name="allowed_pm" id="2" value="ทำงานชดเชยเป็นจำนวน"
                                                ...
                                                <label class="font-weight-normal" for="3">อื่นๆ<input type="text"
                                                        name="other"></label>
                                            </div>
                                            <div class="form-group" id="not_allowed">
                                                <label for="not_allowed">ไม่อนุญาติเนื่องจาก</label>
                                                <textarea class="form-control" name="not_allowed_pm" id="" cols="30"
                                                    rows="4"></textarea>
                                            </div>
