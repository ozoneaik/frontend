...
<head>
    ...
    <style>
        * {
        ...
        /*link.active, .sidebar-light-primary .nav-sidebar>.nav-item>.nav-link.active {*/
        ...
        <ul class="navbar-nav ml-auto">
            <div class="dropdown dropdown-menu-right">
                <button class="btn dropdown-toggle " type="button" id="dropdownMenuButton"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" style="background-color: #e8cff8">
        ...
        <div class="sidebar" >
            ...
            <nav class="mt-2">
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu"
                    ...
                    {{-- Project manager --}}
                    <li class="nav-item menu-open">
                        <a href="#" class="nav-link {{Request::routeIs('req.emp.pm','req_list_emp_detail') ? 'active' : ''}}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item ">
                                <a href="{{route('pm.req.emp')}}" class="nav-link {{Request::routeIs('req.emp.pm','req_list_emp_detail') ? 'active' : ''}}">
                                    <i class="far fa-circle nav-icon"></i>
                    ...
                    {{-- HR --}}
                    <li class="nav-item menu-open">
                        <a href="#" class="nav-link {{Request::routeIs('req.emp.hr','hr_req_list_emp_detail') ? 'active' : ''}}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{route('hr.req.emp')}}" class="nav-link {{Request::routeIs('req.emp.hr','hr_req_list_emp_detail') ? 'active' : ''}}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>รายการคำขอใบลาพนักงาน</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item menu-open">
                        <a href="#" class="nav-link {{Request::routeIs('req.emp.ceo','ceo_req_list_emp_detail') ? 'active' : ''}}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{route('ceo.req.emp')}}" class="nav-link {{Request::routeIs('req.emp.ceo','ceo_req_list_emp_detail') ? 'active' : ''}}">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>รายการคำขอใบลาพนักงาน</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        <a href="{{route('data.users')}}" class="nav-link {{Request::routeIs('data_emp','data_emp_detail') ? 'active' : ''}}">
