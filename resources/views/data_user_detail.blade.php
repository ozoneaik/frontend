                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control"
                                                               value="{{ $users->nick_name }}" disabled>
                                                    </div>
                                                </div>
                                                {{-- ตำแหน่ง --}}
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control"
                                                               value="{{ $users->possition}}" disabled>
                                                    </div>
                                                </div>
                                                {{-- วันเดือนปีเกิด --}}
                                                <div class="col-md-4">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control"
                                                               value="{{ \Carbon\Carbon::parse($users->birthday)->addYears(543)->format('d/m/Y') }}" disabled>
                                                    </div>
                                                </div>
                                                {{-- email --}}
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control"
                                                               value="{{ $users->phone_no_1 }}" disabled>
                                                    </div>
                                                </div>
                                                {{-- เบอร์โทรศัพท์ (รอง) --}}
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control"
                                                               value="{{ $users->phone_no_2 }}" disabled>
                                                    </div>
                                                </div>
                                                {{-- ที่อยู่ --}}
                                                <div class="col-md-12">
